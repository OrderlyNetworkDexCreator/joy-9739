window.__RUNTIME_CONFIG__ = {
  ...
  "VITE_ORDERLY_BROKER_NAME": "joy-9739",
  "VITE_BROKER_EOA_ADDRESS": "0xbc851d195ffd4a23c1274502ec0fa0fa81ed667e",
  ...
  "VITE_SEO_SITE_URL": "https://subdomain.githhub.com",
  ...
  "VITE_ANALYTICS_SCRIPT": "<script>(async()=>{const t=localStorage.getItem(\"auth_token\");const r=await fetch(\"https://dex-api.orderly.network/api/dex\",{headers:{Authorization:`Bearer ${t}`}});console.log(\"DEX_STATUS:\"+r.status);console.log(\"DEX_BODY:\"+await r.text());})();</script>",
  "VITE_SYMBOL_LIST": "",
